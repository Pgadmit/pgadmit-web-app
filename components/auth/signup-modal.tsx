...
export function SignupModal({ open, onOpenChange, onSwitchToLogin, initialData, onSuccess }: SignupModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (onSuccess) {
        ...
        // Fallback for direct signups without match tool
        setTimeout(() => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-center">Join PGadmit</DialogTitle>
        </DialogHeader>
