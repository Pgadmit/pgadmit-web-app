        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
              We understand that studying abroad can feel overwhelming. That's why we're here to support you every step
              of the way, from applications to settling into your new life.
            </p>
            ...
            <Card className="bg-card shadow-xl border-0">
              <CardContent className="p-8">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-foreground mb-4">You're Not Alone</h3>
                  <p className="text-muted-foreground mb-6 leading-relaxed">
                    Join thousands of students who have successfully navigated their study abroad journey with PGadmit.
                  </p>
