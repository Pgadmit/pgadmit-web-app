...
export function AchievementCelebration() {
  const { showCelebration, celebrationMessage, dismissCelebration } = useGamification()
      ...
      >
        <CardContent className="p-6 text-center">
          <div className="mb-4">
            ...
            <h3 className="text-xl font-bold text-foreground mb-2">{celebrationMessage}</h3>
            <p className="text-muted-foreground text-sm">Keep up the great work on your study abroad journey!</p>
          </div>
