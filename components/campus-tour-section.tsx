...
export function CampusTourSection() {
  ...
  return (
    <section data-section="campus-tour" className="py-16 md:py-24 bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            No boring brochures. Real campus vibes, real student life, real talk about what it's actually like.
          </p>
        </div>
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/3 bg-muted/30">
              <CardContent className="p-6 md:p-8">
                <h4 className="font-bold text-foreground mb-6 text-lg">What You'll See</h4>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-background rounded-lg border">
                    <p className="text-sm text-muted-foreground mb-3">Love what you see?</p>
                    <Button
                      size="sm"
                      onClick={navigateToOnboarding}
