      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Hear from parents who trusted us with their children's future and found peace of mind throughout the journey
          </p>
        </div>
            ...
            >
              <CardContent className="p-6">
                ...
                <div className="relative mb-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed pl-6 text-sm">{parent.testimonial}</p>
                </div>
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  />
                  <div>
                    <h4 className="font-semibold text-foreground">{parent.name}</h4>
                ...
                <div className="inline-flex items-center gap-2 bg-primary/10 px-3 py-1 rounded-full">
                  ...
                  <span className="text-xs font-medium text-primary">{parent.highlight}</span>
                </div>
              </CardContent>
            </Card>
          ))}
        ...
        <div className="bg-background rounded-2xl p-8 md:p-10 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">24/7 emergency support and campus safety guidance</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Weekly progress reports and milestone notifications</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <Quote className="h-6 w-6 text-purple-600" />
              </div>
              <h4 className="font-semibold text-foreground mb-2">Transparent Costs</h4>
              <p className="text-sm text-muted-foreground">No hidden fees, clear pricing from day one</p>
            </div>
            <div className="text-center">
          ...
          <div className="text-center mt-10 pt-8 border-t border-muted">
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
              Schedule a free consultation to discuss your child's study abroad journey with our expert counselors
            </p>
