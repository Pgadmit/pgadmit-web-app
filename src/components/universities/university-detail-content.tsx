...
export function UniversityDetailContent({
  university,
  ...
  const regularDeadlineDays = getDaysUntilDeadline(
    university.deadlines.regularDecision
  );
                ...
                <div>
                  ...
                  <div className='flex items-center gap-2 mb-4'>
                    <Badge variant='secondary'>
                      #{university.ranking.global} Global
                    </Badge>
              ...
              <Card className='bg-card shadow-sm'>
                ...
                <CardContent className='space-y-4'>
                  ...
                  <div className='text-sm'>
                    <span
                      className={`font-medium ${regularDeadlineDays <= 30 ? 'text-red-500' : 'text-orange-500'}`}
                    >
                      {regularDeadlineDays} days remaining
                    </span>
                  </div>
                  <Progress
                    value={Math.max(0, 100 - (regularDeadlineDays / 365) * 100)}
                    className='h-2'
                  />
                </CardContent>
              </Card>
              ...
              <Card className='bg-card shadow-sm'>
                ...
                <CardContent className='space-y-3'>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='font-semibold'>
                      ${university.tuition.graduate.toLocaleString()}
                    </span>
                  </div>
          ...
          <TabsContent value='admissions'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <Card>
                ...
                <CardContent className='space-y-3'>
                  {Object.entries(university.requirements.undergraduate).map(
                    ([key, value]) => (
                      <div
                        key={key}
              ...
              <Card>
                ...
                <CardContent className='space-y-3'>
                  {Object.entries(university.requirements.graduate).map(
                    ([key, value]) => (
                      <div
                        key={key}
                        className='flex items-center justify-between'
                  ...
                  <div className='space-y-4'>
                    ...
                    <div className='flex items-center gap-3'>
                      ...
                      <div>
                        ...
                        <div className='text-sm text-muted-foreground'>
                          {university.campusLife.diningPlans}
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className='space-y-4'>
                  <div className='flex items-center justify-between p-4 bg-muted/50 rounded-lg'>
                    ...
                    <div className='text-right'>
                      ...
                      <div className='text-sm text-muted-foreground'>
                        {getDaysUntilDeadline(university.deadlines.earlyAction)}{' '}
                        days left
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='flex items-center justify-between p-4 bg-muted/50 rounded-lg'>
                    <div className='flex items-center gap-3'>
                      ...
                      <div>
                        ...
                        <div className='text-sm text-muted-foreground'>
                          FAFSA and aid applications
                        </div>
                      </div>
                    </div>
                    <div className='text-right'>
                      <div className='font-semibold'>
                        {university.deadlines.financialAid}
                      </div>
                      <div className='text-sm text-muted-foreground'>
                ...
                <div className='space-y-6'>
                  <div className='p-4 bg-muted/50 rounded-lg'>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      "Amazing research opportunities and incredible professors.
                      The campus is beautiful and the student community is very
                      supportive. Highly recommend for international students!"
                    </p>
                  </div>
                  ...
                  <div className='p-4 bg-muted/50 rounded-lg'>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      "The academic rigor is intense but rewarding. Great
                      networking opportunities and career services. The
                      financial aid made it possible for me to attend."
                    </p>
                  </div>
                </div>
              </CardContent>
