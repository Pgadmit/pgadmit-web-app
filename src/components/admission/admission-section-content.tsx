...
export function AdmissionSectionContent({
    ...
    return (
      <div className='bg-gray-50 border border-gray-200 rounded-lg p-8 text-center'>
        ...
        <p className='text-muted-foreground text-lg'>
          Your personalized university matches will appear here after form
          submission
        </p>
      </div>
    );
  ...
  const renderDisclaimer = () => {
    const shouldShowDisclaimer =
      universities.length > 0 && !errorMessage && !loading;
      ...
      <div className='space-y-4'>
        <div className='bg-blue-50/20 border border-blue-200 rounded-lg p-4'>
          <p className='text-xs text-muted-foreground'>
            These university suggestions are generated with the assistance of
            advanced AI, analyzing your submitted profile - including country,
            grading scale, test scores, preferred regions, and intended major.
            The AI evaluates your academic background and preferences to
            recommend universities that could be the best fit for your goals.
          </p>
        </div>
      </div>
    );
    ...
    <div className='flex flex-col lg:flex-row gap-8 lg:gap-12'>
      ...
      <div className='w-full lg:w-1/2'>
        <div className='p-6 h-full flex flex-col'>
          <h3 className='text-2xl font-semibold text-primary-blue mb-6'>
            Your Matches
          </h3>
