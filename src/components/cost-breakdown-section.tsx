      ...
      <div className='container mx-auto px-4 max-w-6xl'>
        <div className='text-center mb-12'>
          ...
          <p className='text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed'>
            Transparent cost breakdown and scholarship opportunities to make
            your dream affordable.
            <span className='font-semibold text-primary'>
              {' '}
              Over 80% of our students receive financial aid!
            </span>
          </p>
        </div>
        ...
        <div className='mb-16'>
          <div className='text-center mb-8'>
            ...
            <p className='text-muted-foreground max-w-2xl mx-auto'>
              Don't let finances hold you back! Explore these funding
              opportunities specifically available for international students.
            </p>
          </div>
              ...
              return (
                ...
                >
                  <CardContent className='p-6 text-center'>
                    ...
                    >
                      <IconComponent
                        className={`h-8 w-8 ${scholarship.color}`}
                      />
                    </div>
        ...
        <Card className='bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 border-0 shadow-2xl'>
          <CardContent className='p-8 text-center'>
            ...
            <h3 className='text-2xl md:text-3xl font-bold text-foreground mb-4'>
              Free Financial Planning Kit 📊
            </h3>
            <p className='text-lg text-muted-foreground mb-6 max-w-2xl mx-auto leading-relaxed'>
              Get our comprehensive guide with cost calculators, scholarship
              databases, budgeting templates, and personalized financial
              roadmaps for international students.
            </p>
