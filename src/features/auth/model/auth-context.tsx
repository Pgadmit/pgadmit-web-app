      ...
      try {
        ...
        if (session?.user) {
          setUser({
            ...
            onboardingComplete:
              session.user.user_metadata?.onboarding_complete || undefined,
    ...
    const {
      ...
      if (event === 'SIGNED_IN' && session?.user) {
        setUser({
          ...
          avatar_url: session.user.user_metadata?.avatar_url,
          onboardingComplete:
            session.user.user_metadata?.onboarding_complete || false,
          createdAt: session.user.created_at,
        });
  ...
  const signIn = async (email: string, password: string) => {
    ...
    try {
      ...
      setUser({
        ...
        onboardingComplete:
          data.user.user_metadata?.onboarding_complete || false,
