...
export function MobileFiltersDrawer({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent
        side='bottom'
        className='h-[85vh] p-0 w-full max-w-full overflow-x-hidden [&>button]:hidden'
      >
        ...
        <div className='flex-1 overflow-y-auto overflow-x-hidden p-4 space-y-6 w-full'>
          ...
          <div className='space-y-2'>
            ...
            <Select
              ...
              onValueChange={value => handleFilterChange('tuitionRange', value)}
            >
              <SelectTrigger>
                <div className='flex items-center gap-2'>
        ...
        <div className='p-4 border-t bg-background w-full'>
          <div className='flex gap-2 w-full'>
            ...
            <Button className='flex-1 min-w-0' onClick={() => setIsOpen(false)}>
