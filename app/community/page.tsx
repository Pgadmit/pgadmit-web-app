    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100 py-8">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">PGadmit Community</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Connect with fellow students, share experiences, and get support from peers on the same journey
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <p className="mb-4">
                  Just got accepted to Stanford for Computer Science! 🎉 The journey was tough but PGadmit's guidance
                  made all the difference. Happy to answer any questions about the application process!
                </p>
            ...
            <Card>
              ...
              <CardContent>
                <p className="mb-4">
                  Any tips for the visa interview? Mine is scheduled for next week and I'm getting nervous. What
                  questions should I prepare for?
                </p>
                <div className="flex items-center gap-4 text-sm text-gray-500">
                  <Button variant="ghost" size="sm">
                    <Heart className="h-4 w-4 mr-1" />
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-sm text-gray-500">Connect with 50+ universities</p>
                </div>
                <div className="border-l-4 border-green-500 pl-4">
                  <h4 className="font-semibold">Visa Workshop</h4>
                  <p className="text-sm text-gray-600">March 20, 2024</p>
                  <p className="text-sm text-gray-500">Expert tips for visa success</p>
                </div>
              </CardContent>
            </Card>
